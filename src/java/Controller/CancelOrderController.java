...
public class CancelOrderController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            check = dao.cancelOrder(Integer.parseInt(id), Integer.parseInt(orderID));

            if (check) {
                url = SUCCESS;
                request.setAttribute("Message", "Canceled Successful");
            } else {
                request.setAttribute("Message", "Canceled Failed");
            }
