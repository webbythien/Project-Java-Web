<%-- 
Document   : info
Created on : Mar 12, 2023, 1:45:03 PM
Author     : thien
--%>
    ...
    <body>
        ...
        <c:choose>
            ...
            <c:when test="${sessionScope.USER.role.equals('US')}">
                ...
                <h1 id="note" style="display: none"> ${sessionScope.Message} </h1>
                <form class="svgContainer">
                    ...
                    <div class="inputGroup inputGroup1">
                        ...
                        <input type="email" id="loginEmail" readonly="" name="email" value="${requestScope.object.getEmail()}" maxlength="254" />
                    </div>
                    <div class="inputGroup inputGroup2">
                        <label for="loginPassword" id="loginPasswordLabel">Password</label>
                        <input name="password" value="" type="password" id="loginPassword" />
                    ...
                    <div class="inputGroup inputGroup1">
                        ...
                        <input type="text" name="name" value="${requestScope.object.getName()}" maxlength="254" />
                    </div>

                    <div class="inputGroup inputGroup1">
                        <input  type="hidden"  name="action" value="InforUser"/>
                        <button   type="submit" name="task" value="Update" onclick="myFunction()">Update</button>  
                    </div>
